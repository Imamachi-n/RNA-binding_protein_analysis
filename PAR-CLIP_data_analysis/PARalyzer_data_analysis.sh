...
python3 ${ScriptDir}/Compare_annotation_infor_with_CLIP-seq_peaks.py ./${savedir}/${bowtiefile}_trx_sites.txt \
																	 ./${savedir}/${bowtiefile}_clusters.result \
																	 ./${savedir}/${CuffdiffGeneFilename}_rep_isoform_list.txt \
																	 ./${savedir}/${bowtiefile}_trx_sites_for_NGS_dataset.txt \
																	 ./${savedir}/${bowtiefile}_trx_sites_for_NGS_dataset.fasta \
																	 ./${savedir}/${bowtiefile}_rep_trx_3UTR.bed
#python3 ${ScriptDir}/Compare_annotation_infor_with_CLIP-seq_peaks_for_bed.py ./${savedir}/${CuffdiffGeneFilename}_rep_isoform_list.txt ./${savedir}/${bowtiefile}_vs_RefSeq_3UTR.bed ./${savedir}/${bowtiefile}_rep_trx_3UTR.bed
